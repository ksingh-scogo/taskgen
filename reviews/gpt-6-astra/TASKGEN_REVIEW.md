...
- Rejected symlinked reference roots/files and credential-like reference content. Rejected symlinked run directories and append sources before artifact creation.
...
- `cargo test --locked`: **200 passed, 1 ignored, 0 failed**.
